...
require (
	...
	golang.org/x/crypto v0.48.0 // v0.0.0-20211108221036-ceb1ce70b4fa
	golang.org/x/net v0.50.0 // indirect; v0.0.0-20210427231257-85d9c07bbe3a indirect
	golang.org/x/oauth2 v0.27.0 // v0.0.0-20210514164344-f6687ab2804c
	golang.org/x/sys v0.42.0 // indirect; v0.0.0-20210630005230-0f9fa26af87c indirect
