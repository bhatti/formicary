-- +goose Up
    CREATE TABLE IF NOT EXISTS formicary_job_definitions (
      ...
      retention_days_for_failed INTEGER NOT NULL DEFAULT 30,
      retention_days_for_completed INTEGER NOT NULL DEFAULT 7,
      retention_days_for_cancelled INTEGER NOT NULL DEFAULT 30,
      url VARCHAR(150),
