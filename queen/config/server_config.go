...
func NewServerConfig(id string) (*ServerConfig, error) {
	...
	viper.SetDefault("common.auth.jwt_secret", "")
	viper.SetDefault("common.auth.cookie_name", "formicary-session")
	viper.SetDefault("common.auth.secure", "false")
	viper.SetDefault("common.auth.google_client_id", "")
	viper.SetDefault("common.auth.google_client_secret", "")
	viper.SetDefault("common.auth.google_callback_host", "localhost")
	viper.SetDefault("common.auth.github_client_id", "")
	viper.SetDefault("common.auth.github_client_secret", "")
	viper.SetDefault("common.auth.github_callback_host", "localhost")
