...
#   FORMICARY_URL           e.g. https://10.8.97.24.nip.io
...
info "  ${FORMICARY_URL:-https://10.8.97.24.nip.io}/dashboard → click your name (bottom nav) → API Tokens"

prompt_var FORMICARY_URL   "Formicary server URL"    "e.g. https://10.8.97.24.nip.io" required
